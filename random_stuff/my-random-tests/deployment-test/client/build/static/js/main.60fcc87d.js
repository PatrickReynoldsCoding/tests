/*! For license information please see main.60fcc87d.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
  ...
  !(function () {
    ...
    function p(e) {
      ...
      return t.map(function (e) {
        return (0,
        f.jsx)(d, { obId: e._id, toggleComplete: n, todo: e.message, complete: e.complete }, e._id);
      });
    }
    var h = (function () {
        var e = s(
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.prev = 0),
                        (e.next = 3),
                        fetch("http://localhost:8080/".concat(t), {
                          method: "PATCH",
                          headers: { "Content-Type": "application/json" },
                        })
                      );
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.prev = 0),
                        (e.next = 3),
                        fetch("http://localhost:8080/deleteCompleted", {
                          method: "DELETE",
                          headers: { "Content-Type": "application/json" },
                        })
                      );
    ...
    var b = function () {
          ...
          l().mark(function e(t) {
            ...
            return l().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    if ("" !== (i = a.current.value)) {
                      e.next = 3;
                      break;
                    }
                    return e.abrupt("return");
                  case 3:
                    (s = { message: i, complete: !1 }),
                      r(function (e) {
                        return [].concat(u(e), [s]);
                      }),
                      m(s),
      ...
      return (0, f.jsxs)(f.Fragment, {
        children: [
          ...
          (0, f.jsx)("input", { ref: a, type: "text" }),
          (0, f.jsx)("button", { onClick: i, children: "Add Todo" }),
          (0, f.jsx)("button", {
            onClick: function () {
              y(), o();
            },
    ...
    t.createRoot(document.getElementById("root")).render(
      (0, f.jsx)(e.StrictMode, { children: (0, f.jsx)(b, {}) })
    );
  })();
})();
//# sourceMappingURL=main.60fcc87d.js.map
